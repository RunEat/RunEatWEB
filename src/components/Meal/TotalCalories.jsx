...
const TotalCalories = ({ meal }) => {
  ...
  const [colorCirc, setColorCirc] = useState('red')

  const { user } = useUser();

  // const circProgressColor = () => {
  //   (maxCalories > calories) ? return(
  //     return buildStyles({
