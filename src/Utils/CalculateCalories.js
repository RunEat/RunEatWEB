export const maximumCalories = (user) => {
  ...
  //     case 'Weight loss': return (TDEE * 0.2) break; // Weight loss diet --> 20% calorie deficit
...
export const maximumCarbs = (TDEE) => {
  ...
  //     case 'Weight loss': (TDEE * 0.4) / 4 break; // Weight loss diet --> 40% carbs
  //     case 'Weight gain': (TDEE * 0.55) / 4 break; // Weight gain diet --> 55% carbs
  //     case 'Default': throw new Error("Meal plan is required") break;
  // }
};
...
export const maximumProteins = (TDEE) => {
  ...
  //     case 'Weight loss': return (TDEE * 0.4) / 4 break; // Weight loss diet --> 40% proteins
  //     case 'Weight gain': (TDEE * 0.25) / 4 break; // Weight gain diet --> 25% proteins
  //     case 'Default': throw new Error("Meal plan is required") break;
  // }
};
...
export const maximumFats = (TDEE) => {
  ...
  const maximumFats = (TDEE * 0.25) / 4;
  return maximumFats;

  // switch(mealPlan) {
  //     case 'Balanced diet': return (TDEE * 0.25) / 9 break; // Balanced diet --> 25% fats
  //     case 'Weight loss': return (TDEE * 0.2) / 9 break; // Weight loss diet --> 20% fats
  //     case 'Weight gain': return (TDEE * 0.25) / 9 break; // Weight gain diet --> 25% fats
  //     case 'Default': throw new Error("Meal plan is required") break;
  // }
};
